...
public class MainFX extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        TextMenu menu = createTextMenu();

        ControllerFX controllerFX = loader.getController();
        controllerFX.setPrimaryStage(primaryStage);
        controllerFX.setMenu(menu);
        controllerFX.setListOfCommands();
        controllerFX.setFashion();


        primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("Style/Icon.jpg")));
        primaryStage.setTitle("Toy Language");


        primaryStage.setScene(new Scene(root));
        primaryStage.getScene().getStylesheets().add("Style/main_window_dark.css");
        primaryStage.show();
    ...
    private static Controller createProgramState(IStatement statement, String logFilePath){
        ...
        ProgramState programState = new ProgramState(new MyStack<>(statement), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap<>(), new MySemaphore());
    ...
    public static TextMenu createTextMenu(){
        ...
        IStatement ex11 = new CompoundStatement(new VariableDeclarationStatement("v1", new ReferenceType(new IntType())),
                new CompoundStatement(new VariableDeclarationStatement("cnt", new IntType()),
                        new CompoundStatement(new HeapAllocateStatement("v1", new ValueExpression(new IntValue(1))),
                                new CompoundStatement(new NewSemaphore("cnt", new HeapReadExpression(new VariableExpression("v1"))),
                                        new CompoundStatement(new ForkStatement(new CompoundStatement( new Acquire("cnt"),
                                                     new CompoundStatement(new HeapWriteStatement("v1", new ArithmeticalExpression("*", new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))),
                                                ...
                                                new CompoundStatement(new ForkStatement(new CompoundStatement(new Acquire("cnt"),
                                                        new CompoundStatement(new HeapWriteStatement("v1", new ArithmeticalExpression("*", new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(10)))),
                                                                new CompoundStatement(new HeapWriteStatement("v1", new ArithmeticalExpression("*", new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(2)))),
                                                        ...
                                                        new CompoundStatement(new Acquire("cnt"),
                                                                new CompoundStatement(new PrintStatement( new ArithmeticalExpression("-", new HeapReadExpression(new VariableExpression("v1")), new ValueExpression(new IntValue(1)))),
                                                                        new Release("cnt")))))))));

        Controller controller11 = createProgramState(ex11, "files\\log11.txt");
